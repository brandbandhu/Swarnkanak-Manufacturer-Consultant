  ...
  head: () => ({
    meta: [
      { title: "Reset Your Password | Swarnkanak Portal" },
      {
        name: "description",
        content:
          "Recover access to your Swarnkanak customer portal account using mobile OTP verification.",
      },
  ...
  return (
    <SiteLayout>
      <PageHeading
        ...
        subtitle="Verify your registered mobile number to set a new password."
      />
          ...
          <CardContent className="space-y-4 p-6">
            ...
            {step === 1 && (
              <>
                ...
                <Button
                  className="w-full"
                  onClick={() => (otp === "123456" ? setStep(2) : toast.error("Invalid OTP"))}
                >
                  Verify OTP
                </Button>
              </>
            ...
            {step === 2 && (
              <>
                ...
                <Button
                  className="w-full"
                  onClick={() =>
                    pw && pw === cpw ? setStep(3) : toast.error("Passwords do not match")
                  }
                >
                  Reset password
                </Button>
