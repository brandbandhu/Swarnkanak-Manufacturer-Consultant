...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Log in to the Swarnkanak customer portal to track orders, manage quotations and access your dashboard." },
      { property: "og:title", content: "Customer Login | Swarnkanak Portal" },
      { property: "og:description", content: "Secure login for Swarnkanak customers and administrators." },
    ],
  }),
  component: LoginPage,
});
...
function LoginPage() {
  ...
  return (
    <SiteLayout>
      <PageHeading title="Login to Your Account" subtitle="Access your dashboard, orders, quotations and support tickets." />
      <div className="container-x grid max-w-4xl gap-6 py-12 md:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                <Input id="pw" type={show ? "text" : "password"} value={pw} onChange={(e) => setPw(e.target.value)} required autoComplete="current-password" />
        ...
        <Card className="h-fit bg-muted/60"><CardContent className="space-y-3 p-6 text-sm">
          <h2 className="font-display text-base font-semibold">Demo credentials</h2>
          <p className="text-muted-foreground">Marked for client demonstration only — change before production deployment.</p>
