  ...
  head: () => ({
    meta: [
      { title: "Order Confirmed | Swarnkanak Machinery" },
      {
        name: "description",
        content:
          "Your agricultural machinery order has been placed successfully. Track status, download the acknowledgement or continue shopping.",
      },
      { property: "og:title", content: "Order Confirmed | Swarnkanak" },
      {
        property: "og:description",
        content: "Order placed successfully with Swarnkanak Manufacturer & Consultant.",
      },
    ],
  }),
          ...
          <CardContent className="space-y-5 p-8 text-center">
            ...
            {order && (
              <div className="space-y-2 rounded-lg border p-5 text-left text-sm">
                ...
                <p>
                  <span className="font-semibold">Estimated delivery:</span> 5-8 working days
                </p>
              </div>
            )}

            <div className="flex flex-wrap justify-center gap-3">
              <Button onClick={() => toast.success("Acknowledgement downloaded (demo)")}>
                <Download className="size-4" /> Download acknowledgement
              </Button>
              <Button variant="outline" asChild>
                <Link to="/dashboard/orders">View order</Link>
              </Button>
