  ...
  head: () => ({
    meta: [
      { title: "Create Your Customer Account | Swarnkanak Portal" },
      {
        name: "description",
        content:
          "Register as a farmer, dealer, distributor or institution to order agricultural machinery, request quotations and track deliveries.",
      },
      { property: "og:title", content: "Create Your Customer Account | Swarnkanak" },
      {
        property: "og:description",
        content: "Free registration for the Swarnkanak agricultural machinery customer portal.",
      },
    ],
  }),
...
function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (!PW_RULE.test(data.password ?? ""))
      e.password = "Minimum 8 characters with uppercase, lowercase, number and special character";
  ...
  return (
    <SiteLayout>
      <PageHeading
        ...
        subtitle="Register once to order machinery, request quotations and manage support from a single dashboard."
      />
            ...
            {stage === "form" ? (
              ...
              >
                ...
                <div>
                  ...
                  >
                    {["Farmer", "Dealer", "Distributor", "Business", "Institution"].map((t) => (
              ...
              <div className="mx-auto max-w-sm space-y-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  We sent a 6-digit code to {data.phone}. Demo OTP:{" "}
                ...
                <Button variant="ghost" className="w-full" onClick={() => setStage("form")}>
                  Back to form
                </Button>
              </div>
            )}
